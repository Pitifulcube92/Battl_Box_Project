		...
		.Content()[
			...
			+ SVerticalBox::Slot()
				[
					...
					[
						SNew(STextBlock)
						.Text(LOCTEXT("Action Name", "Action Name"))
					]
					+ SHorizontalBox::Slot()
					.VAlign(VAlign_Center)
					[
			...
			+ SVerticalBox::Slot()
				[
					...
					[
						SNew(STextBlock)
						.Text(LOCTEXT("Action Tag" , "Action Tag"))
					]
					+SHorizontalBox::Slot()
					.VAlign(VAlign_Center)
					[
					...
					.VAlign(VAlign_Center)
						[
							...
							[
								...
								+ SVerticalBox::Slot()[
									SNew(STextBlock)
										.Text(LOCTEXT("Enum NONE", "E_NONE"))
								]
								+SVerticalBox::Slot()[
									SNew(STextBlock)
									.Text(LOCTEXT("Enum COMMAND", "E_COMMAND"))
								]
								+ SVerticalBox::Slot()[
									SNew(STextBlock)
									.Text(LOCTEXT("Enum ITEM", "E_ITEM"))
								]
								+ SVerticalBox::Slot()[
									SNew(STextBlock)
									.Text(LOCTEXT("Enum ABITLY", "E_ABILITY"))
								]
							]
						]
				]
